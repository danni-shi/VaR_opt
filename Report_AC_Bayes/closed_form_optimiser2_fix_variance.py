...
# To store results
delta_results = {}
gamma_list = [[1, np.float64(0.00175), np.float64(0.0)],
 [2, np.float64(0.0015), np.float64(0.0)],
 [3, np.float64(0.0012), np.float64(0.0)],
 [4, np.float64(0.001), np.float64(0.0)]]
...
import pickle
results_dir = f"closed_form_prior_quick_fixed_var"
os.makedirs(results_dir, exist_ok=True)
pickle_file = os.path.join(results_dir, "closed_form_prior_fixed_var.pkl")
